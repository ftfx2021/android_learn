...
applications.curtain_switch = OFF
sendData()
application.FanData.switch = OFF
sendData()
...
```
void mode_home(){
if(temperature > autoModeData.fan_temperature.high && autoModeData.fan_temperature.state = ON){
  applications.FanData.switch = ON
  sendData()
}
if(temperature < autoModeData.fan_temperature.low && autoModeData.fan_temperature.state = ON){
  applications.FanData.switch = OFF
  sendData()
}
if(light > autoModeData.led_light.high && autoModeData.led_light.state = ON){
  applications.livingrom_led.state = ON
  sendData()
}
if(light < autoModeData.led_light.low && autoModeData.led_light.state = ON){
  applications.livingrom_led.state = OFF
  sendData()
}
if(light > autoModeData.curtain_light.high && autoModeData.curtain_light.state = ON){
  applications.curtain_switch = ON
  sendData()
}
if(light < autoModeData.curtain_light.low && autoModeData.curtain_light.state = ON){
  applications.curtain_switch = OFF
  sendData()
}
